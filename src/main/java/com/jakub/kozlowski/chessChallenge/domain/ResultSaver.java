...
class ResultSaver {
    static void printResults(Collection<FieldType[]> configurations, Integer totalLength){
        configurations.forEach(configuration->printResults(configuration, totalLength));
    }

    private static void printResults(FieldType[] configuration, Integer totalLength){
